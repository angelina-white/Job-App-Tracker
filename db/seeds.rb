...
puts "seeding jobs"
job1 = Job.create(dateApplied: "07/08/22", description: "do go code for hotel homes", applicationLink:"www.fakeapplink1.com", status_id: pending.id, company_id: airbnb.id)
job2 = Job.create(dateApplied: "07/09/22", description: "do code for music", applicationLink:"www.fakeapplink2.com", status_id: pending.id, company_id: spotify.id)
job3 = Job.create(dateApplied: "07/10/22", description: "do code for fast fashion", applicationLink:"www.fakeapplink3.com", status_id: pending.id, company_id: aritzia.id)
job4 = Job.create(dateApplied: "07/11/22", description: "do code for athletic wear", applicationLink:"www.fakeapplink4.com", status_id: pending.id, company_id: lululemon.id)